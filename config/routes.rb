...
Rails.application.routes.draw do
  ...
  resources :representatives do
    ...
    #splitting routes
    post '/representatives/:representative_id/my_news_item/select' => 'my_news_items#select', #work on later, change post to get
    :as                                                    => :select_my_news_item
    post '/representatives/:representative_id/my_news_item/save' => 'my_news_items#save', 
    :as                                                    => :save_my_news_item
  ...
  get '/representatives/:representative_id' => 'representatives#show', :as => 'rep'
end
